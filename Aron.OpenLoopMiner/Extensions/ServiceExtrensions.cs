...
using Aron.OpenLoopMiner.Data;
using Microsoft.AspNetCore.Identity;
using Aron.OpenLoopMiner.Jobs;
using Aron.OpenLoopMiner.Services;
using Aron.OpenLoopMiner.Helpers;
...
namespace Aron.OpenLoopMiner.Extensions
{
    public static class ServiceExtrensions
    {
        ...
        {
            if (Environment.GetEnvironmentVariables().Contains("OL_USER"))
            {
                appConfig.UserName = Environment.GetEnvironmentVariable("OL_USER").ToString();
            }

            if (Environment.GetEnvironmentVariables().Contains("OL_PASS"))
            {
                appConfig.Password = Environment.GetEnvironmentVariable("OL_PASS").ToString();
            }
