...
namespace Aron.OpenLoopMiner.Helpers
{
    public class JwtHelpers
    {
        ...
        public string GenerateToken(string userName, IEnumerable<string> roles = null, TimeSpan? exp = null)
        {
            if(exp == null)
            {
                exp = TimeSpan.FromMinutes(3);
            }
